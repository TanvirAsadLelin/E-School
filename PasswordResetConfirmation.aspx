<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PasswordResetConfirmation.aspx.cs" Inherits="PasswordResetConfirmation" %>
        ...
        <div class="wrapper">
            ...
            <div class="p-3 mt-6">
                ...
                <div class="text-center">
                     <asp:Label ID="lblCEmailCheck" CssClass="msg" runat="server">
                                We have sent you a reset password email.<br />
                                Please check your email to reset password.</asp:Label>
                </div>
            ...
            <div class="text-center fs-6 mt-3"> <a href="Login.aspx"
